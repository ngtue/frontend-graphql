<template>
  <div class="book-edit">
    <div class="container mx-auto px-5 lg:px-40 mt-10">
      <h1 class="text-2xl text-purple-700 mb-5">Edit book</h1>
      <form action="#" method="POST" @submit.prevent="editBook">
        ...
        <div class="form-group">
          <button type="submit" class="bg-green-600 hover:bg-green-500 text-white font-bold rounded px-4 py-2">Update</button>
        </div>
      </form>
    </div>
  </div>
...
<script>
import editBookQuery from "@/graphql/mutations/edit-book.gql";
